...
This is a web application that allows a user to add job postings to a job board.
...
* `git clone https://github.com/sheenanick/java-job-board` to clone this repository
* `gradle run`
